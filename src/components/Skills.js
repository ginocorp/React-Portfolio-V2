            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="card-body">
                  ...
                  <br />
                  <br />
                  <div className="h4 mt-0 title">Essential Skills</div>
                  {skills["Essential Skills"].split(",").map((p_lan) => (
                    <button type="button" className="btn btn-warning">
              ...
              <div className="col-lg-6 col-md-12">
                <div className="card-body">
                  ...
                  <br />
                  <br />
                  <div className="h4 mt-0 title">Others & Certifications</div>
                  {skills["Others & Certifications"].split(",").map((other) => (
                    <button type="button" className="btn btn-warning">
                      {other}{" "}
                      <i className="fa fa-check" aria-hidden="true">
                        {" "}
